...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Deconv_upsample layer 4 conv
    skip1_out_deconv = tf.layers.conv2d_transpose(skip1,
                                                  num_classes,
                                                  kernel_size=4,
                                                  strides=(2, 2),
                                                  padding='same',
    ...
    # Deconv_upsample layer 3 conv
    skip2_out_deconv = tf.layers.conv2d_transpose(skip2,
                                                  num_classes,
                                                  kernel_size=16,
                                                  strides=(8, 8),
                                                  padding='same',
...
def optimize(nn_last_layer, correct_label, learning_rate, num_classes):
    ...
    # logits will be a 2D tensor where each row would represent a pixel and each column a class
